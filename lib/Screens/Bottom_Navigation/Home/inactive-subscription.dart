...
class InactiveSubs extends StatefulWidget {
  const InactiveSubs({super.key});

  @override
  State<InactiveSubs> createState() => _InactiveSubsState();
}

class _InactiveSubsState extends State<InactiveSubs> {
  @override
